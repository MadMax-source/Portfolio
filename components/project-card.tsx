    ...
    >
      <div
        className={`relative h-full rounded-2xl border bg-gradient-to-br ${
          categoryColors[project.category] || 'from-gray-500/20 to-gray-600/20 border-gray-500/30'
        } backdrop-blur-sm overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10`}
      >
        {/* Glow Effect */}
